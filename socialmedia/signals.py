...
from socialmedia.tasks import create_image_from_scheduled_social_post_instance, create_image_from_regular_social_post_instance, promote_scheduled_social_post_instance
